...
import SignImg from '../Component/assets/SignIn.PNG'
...
function SignIn() {
  ...
  return (
    <>
      <Grid container p={14} alignItems={'center'} justifyContent={'center'}>
        <Grid item md={5} xs={12}
          sx={{ ...inputStyles }}>
          <Box sx={{ padding: { md: 'none', xs: '30px' } }}>
            <Typography variant='h4' fontWeight={700}>Sign In</Typography>
            <Typography fontWeight={400} color={'#666'} marginTop={'10px'}>to Continue to Phrama-buddy </Typography>
            <form onSubmit={handleChange}>
              <Stack direction={'column'} spacing={3} mt={2}>
                ...
                <Stack direction={'row'} spacing={5}>
                  <Typography>No Account ? <Link to='/signup' style={{ textDecoration: 'none', color: '#666' }}><span>Sign Up</span></Link></Typography>
                  <div >
                    {
                      msg !== "" ?
