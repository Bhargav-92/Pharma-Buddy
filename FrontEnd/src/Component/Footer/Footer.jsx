        ...
        <>
            <Grid container
                sx={{
                    ...
                    alignItems: 'center',
                    background: '#11333A', // Darker background color
                    color: '#fff',
                ...
                <Grid item md={3}>
                    <Stack spacing={1.5} direction={'column'}>
                        ...
                        <Link to='/product' style={{ color: "#fff", textDecoration: 'none' }}>
